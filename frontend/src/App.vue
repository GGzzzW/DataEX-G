...
<template>
  <main class="app-shell">
    ...
    <nav class="workspace-tabs" aria-label="工作区">
      ...
      <button
        :class="{ active: activeWorkspace === 'analysis' }"
        @click="activeWorkspace = 'analysis'"
      >
        回归分析方法
      </button>
      <button
        :class="{ active: activeWorkspace === 'spatial' }"
        @click="activeWorkspace = 'spatial'"
      >
        空间分析
      </button>
    </nav>
    ...
    <div v-show="activeWorkspace === 'analysis'" class="workspace-view">
      <AnalysisWorkspace />
    </div>
